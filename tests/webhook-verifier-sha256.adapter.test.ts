...
import { WebhookVerifierSha256Adapter } from "../src/webhook-verifier-sha256.adapter";
...
const verifier = new WebhookVerifierSha256Adapter(secret);

describe("WebhookVerifierSha256Adapter", () => {
  test("verify - true", () => {
