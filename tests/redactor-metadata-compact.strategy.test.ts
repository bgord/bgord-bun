...
const redactor = new RedactorMetadataCompactStrategy();

describe("RedactorMetadataCompactStrategy", () => {
  test("happy path", () => {
    const redactor = new RedactorMetadataCompactStrategy({ maxKeys: tools.IntegerPositive.parse(5) });
  ...
  test("keeps small objects unchanged", () => {
    ...
    const redactor = new RedactorMetadataCompactStrategy({ maxKeys });
  ...
  test("keep non-objects unchanged ", () => {
    ...
    const redactor = new RedactorMetadataCompactStrategy({ maxKeys: tools.IntegerPositive.parse(10) });
    const input = {
      bag: {
        arr: [1, 2, 3],
